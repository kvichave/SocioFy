...
from dashboard.instafetch import get_comments,generate_reply
...
def gen_reply(request):
    ...
    if request.method=="POST":
        ...
        comments_replies=generate_reply(comm_id=value,access_token=str(access_token))
        ...
        return JsonResponse({"value":value,"reply":reply})
